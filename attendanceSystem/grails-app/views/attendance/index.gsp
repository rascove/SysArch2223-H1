...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="list-attendance" class="col-12 content scaffold-list" role="main">
                    <h1>Not available</h1>
                    <g:if test="${flash.message}">
                        <div class="message" role="status">${flash.message}</div>
                    </g:if>
                    <!--<f:table collection="${attendanceList}" />-->

                    <g:if test="${attendanceCount > params.int('max')}">
                    <div class="pagination">
                        <g:paginate total="${attendanceCount ?: 0}" />
                    </div>
                    </g:if>
                </div>
            </section>
