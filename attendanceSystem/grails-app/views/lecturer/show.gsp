...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="show-lecturer" class="col-12 content scaffold-show" role="main">
                    ...
                    <g:form resource="${this.lecturer}" method="DELETE">
                        <fieldset class="buttons">
                            <g:link class="edit" action="edit" resource="${this.lecturer}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
