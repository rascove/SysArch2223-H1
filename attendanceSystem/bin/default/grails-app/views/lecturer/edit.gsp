...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            <section class="row">
                <a href="#edit-lecturer" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
            ...
            <section class="row">
                <div id="edit-lecturer" class="col-12 content scaffold-edit" role="main">
