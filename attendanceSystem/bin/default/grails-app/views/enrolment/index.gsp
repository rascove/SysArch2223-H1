...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="list-enrolment" class="col-12 content scaffold-list" role="main">
                    <h1>Not available</h1>
                    <g:if test="${flash.message}">
                        <div class="message" role="status">${flash.message}</div>
                    </g:if>
                    <!--<f:table collection="${enrolmentList}" except="[]" />-->

                    <g:if test="${enrolmentCount > params.int('max')}">
                    <div class="pagination">
                        <g:paginate total="${enrolmentCount ?: 0}" />
                    </div>
                    </g:if>
                </div>
            </section>
